...
namespace BasicJab.ComInterface
{
    ...
    public interface IUtility
    {
        ...
        void MoveCursorTo(int x, int y, bool detect_scaling = false);
        void Click_Left_Mouse(int x, int y, int holdSeconds = 0, bool detect_scaling = false);
        void Click_Right_Mouse(int x, int y, int holdSeconds = 0, bool detect_scaling = false);
